...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2387944393ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7c45602378576757213c513d43565630">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="shop_db" targettable="orders">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">UPDATE `products` SET `id`=&#039;1&#039;,`name`=&#039;Boring Girls&#039;,`price`=&#039;100&#039;,`image`=&#039;boring_girls_a_novel.png&#039; WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="message">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `message`</span>
                        </div>
                                            <div class="message history collapsed hide select"
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`id`, `name`, `price`, `image`) VALUES (&#039;1&#039;,&#039;Boring Girls&#039;,&#039;100&#039;,&#039;boring_girls_a_novel.PNG&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`name`, `price`, `image`) VALUES 
(&#039;Dermacol Make-up Cover 209&#039;,&#039;99.95&#039;,&#039;p1.png&#039;),
(&#039;Dermacol Satin Make-Up Base 10 ml&#039;,&#039;99.95&#039;,&#039;p2.png&#039;),
(&#039;Sisley Instant Correct 1-ounce Color Correcting&#039;,&#039;99.95&#039;,&#039;p3png&#039;),
(&#039;Dermacol Make-up Cover 213&#039;,&#039;99.95&#039;,&#039;p4png&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="shop_db" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`name`, `price`, `image`) VALUES 
(&#039;Dermacol Satin Make-Up Base 30 ml&#039;,&#039;95.99&#039;,&#039;p6.png&#039;),
(&#039;Maybelline Master Fixer Makeup Remover Pen&#039;,&#039;90.50&#039;,&#039;p7.png&#039;);</span>
                        </div>
